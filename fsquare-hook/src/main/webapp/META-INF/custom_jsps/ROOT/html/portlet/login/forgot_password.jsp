...
<h1><%= LanguageUtil.get(pageContext, "forgot-password-title") %></h1>
...
<aui:form action="<%= forgotPasswordURL %>" method="post" name="fm" cssClass="form-horizontal">
			...
			<c:when test="<%= (user2 != null) && Validator.isNotNull(user2.getEmailAddress()) %>">
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<aui:button-row style="margin: 20px 0;">
