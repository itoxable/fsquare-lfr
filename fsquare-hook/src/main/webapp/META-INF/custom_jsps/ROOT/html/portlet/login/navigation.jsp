...
<c:if test="<%= Validator.isNotNull(navigation) %>">
	...
	<div class="navigation">
		<p class="social-legend text-center"><%= LanguageUtil.get(pageContext, "login.help") %></p>
		<%= navigation %>
		<% if (!ParamUtil.getString(request, "struts_action").equals("/login/login")) { %>
		 	<a class="sign-in" href="<%= themeDisplay.getURLSignIn() %>">
