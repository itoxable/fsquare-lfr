...
List<ShoppingOrder> shoppingOrderList = ShoppingOrderLocalServiceUtil.findBygroupIdAndUserId(themeDisplay.getScopeGroupId(),themeDisplay.getUser().getUserId());
