...
<div class="modal" id="<portlet:namespace />shipping_form">
	<div class="modal-header">
		...
		<h3><%= LanguageUtil.get(locale, "shipping-method") %></h3>
	</div>
	<div class="modal-body">
		<aui:form id='shipping-form'>
			<div class="">	
				...
				<aui:input inlineField="<%=true %>" cssClass="text-area" name="description" type="textarea" value="<%= shoppingShippingMethod.getDescription() %>" placeholder="Description" />
