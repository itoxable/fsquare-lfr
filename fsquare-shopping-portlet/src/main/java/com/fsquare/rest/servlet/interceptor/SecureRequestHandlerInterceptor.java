package com.fsquare.rest.servlet.interceptor;
...
public final static List<String> METHODS_TO_CHECK = Collections.unmodifiableList(Arrays.asList("POST","GET", "PUT", "DELETE"));
	...
	protected HttpServletRequest basicAuth(HttpServletRequest request, HttpServletResponse response)
		throws Exception {
	...
	protected HttpServletRequest setCredentials(HttpServletRequest request, HttpSession session, long userId, String authType)
		throws Exception {
	...
	protected void initThreadLocals(long userId) throws Exception {
	...
	protected HttpServletRequest digestAuth(HttpServletRequest request, HttpServletResponse response)
		throws Exception {
	...
	private static final String _AUTHENTICATED_USER = SecureRequestHandlerInterceptor.class + "_AUTHENTICATED_USER";

	private static final String _BASIC_REALM = "Basic realm=\"" + Portal.PORTAL_REALM + "\"";

	private static final String _DIGEST_REALM = "Digest realm=\"" + Portal.PORTAL_REALM + "\"";
