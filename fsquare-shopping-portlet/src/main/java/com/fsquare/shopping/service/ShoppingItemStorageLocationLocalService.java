...
/**
 * Provides the local service interface for ShoppingItemStorageLocation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ShoppingItemStorageLocationLocalServiceUtil
...
public interface ShoppingItemStorageLocationLocalService
    extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ShoppingItemStorageLocationLocalServiceUtil} to access the shopping item storage location local service. Add custom service methods to {@link com.fsquare.shopping.service.impl.ShoppingItemStorageLocationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
