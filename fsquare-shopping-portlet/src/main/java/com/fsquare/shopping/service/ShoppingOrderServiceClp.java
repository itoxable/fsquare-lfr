...
public class ShoppingOrderServiceClp implements ShoppingOrderService {
    ...
    public ShoppingOrderServiceClp(InvokableService invokableService) {
        ...
        _methodName5 = "findBygroupIdAndEmail";

        _methodParameterTypes5 = new String[] { "long", "java.lang.String" };

        _methodName6 = "getOrderTotal";

        _methodParameterTypes6 = new String[] { "java.util.Collection" };

        _methodName7 = "getOrderItemsCount";

        _methodParameterTypes7 = new String[] { "java.util.Collection" };
    }
