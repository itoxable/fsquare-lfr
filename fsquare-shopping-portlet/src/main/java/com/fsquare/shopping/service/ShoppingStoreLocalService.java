...
/**
 * Provides the local service interface for ShoppingStore. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ShoppingStoreLocalServiceUtil
...
public interface ShoppingStoreLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ShoppingStoreLocalServiceUtil} to access the shopping store local service. Add custom service methods to {@link com.fsquare.shopping.service.impl.ShoppingStoreLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
