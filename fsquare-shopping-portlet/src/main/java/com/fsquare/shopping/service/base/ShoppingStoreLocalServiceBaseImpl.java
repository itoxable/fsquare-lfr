...
import com.fsquare.shopping.service.ShoppingStoreLocalService;
...
/**
 * Provides the base implementation for the shopping store local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsquare.shopping.service.impl.ShoppingStoreLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ShoppingStoreLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ShoppingStoreLocalService,
        IdentifiableBean {
    ...
    private ShoppingStoreLocalServiceClpInvoker _clpInvoker = new ShoppingStoreLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.fsquare.shopping.service.ShoppingStoreLocalServiceUtil} to access the shopping store local service.
     */
    ...
    @Override
    public ShoppingStore addShoppingStore(ShoppingStore shoppingStore)
        throws SystemException {
        shoppingStore.setNew(true);

        return shoppingStorePersistence.update(shoppingStore);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public ShoppingStore deleteShoppingStore(ShoppingStore shoppingStore)
        throws SystemException {
        return shoppingStorePersistence.remove(shoppingStore);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(ShoppingStore.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return shoppingStorePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return shoppingStorePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return shoppingStorePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<ShoppingStore> getShoppingStores(int start, int end)
        throws SystemException {
        return shoppingStorePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getShoppingStoresCount() throws SystemException {
        return shoppingStorePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public ShoppingStore updateShoppingStore(ShoppingStore shoppingStore)
        throws SystemException {
        return shoppingStorePersistence.update(shoppingStore);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.fsquare.shopping.model.ShoppingStore",
            shoppingStoreLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = shoppingStorePersistence.getDataSource();
