...
import com.fsquare.shopping.service.SiteCommonActionsLocalService;
...
/**
 * Provides the base implementation for the site common actions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsquare.shopping.service.impl.SiteCommonActionsLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class SiteCommonActionsLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements SiteCommonActionsLocalService,
        IdentifiableBean {
    ...
    private SiteCommonActionsLocalServiceClpInvoker _clpInvoker = new SiteCommonActionsLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.fsquare.shopping.service.SiteCommonActionsLocalServiceUtil} to access the site common actions local service.
     */
