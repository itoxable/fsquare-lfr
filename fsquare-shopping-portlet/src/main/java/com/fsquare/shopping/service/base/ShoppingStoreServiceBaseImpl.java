...
import com.fsquare.shopping.service.ShoppingStoreService;
...
/**
 * Provides the base implementation for the shopping store remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsquare.shopping.service.impl.ShoppingStoreServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ShoppingStoreServiceBaseImpl extends BaseServiceImpl
    implements ShoppingStoreService, IdentifiableBean {
    ...
    private ShoppingStoreServiceClpInvoker _clpInvoker = new ShoppingStoreServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.fsquare.shopping.service.ShoppingStoreServiceUtil} to access the shopping store remote service.
     */
