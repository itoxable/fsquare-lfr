...
/**
 * Provides the local service interface for ShoppingStorageLocation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ShoppingStorageLocationLocalServiceUtil
...
public interface ShoppingStorageLocationLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ShoppingStorageLocationLocalServiceUtil} to access the shopping storage location local service. Add custom service methods to {@link com.fsquare.shopping.service.impl.ShoppingStorageLocationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
