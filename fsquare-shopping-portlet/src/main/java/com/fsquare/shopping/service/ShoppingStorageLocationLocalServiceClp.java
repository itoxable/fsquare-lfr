 ...
 * @generated
 */
public class ShoppingStorageLocationLocalServiceClp
    ...
    public ShoppingStorageLocationLocalServiceClp(
    ...
    public com.fsquare.shopping.model.ShoppingStorageLocation addShoppingStorageLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(shoppingStorageLocation)
                    });
        } catch (Throwable t) {
        ...
        return (com.fsquare.shopping.model.ShoppingStorageLocation) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.fsquare.shopping.model.ShoppingStorageLocation createShoppingStorageLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { storageLocationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingStorageLocation deleteShoppingStorageLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { storageLocationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingStorageLocation fetchShoppingStorageLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { storageLocationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingStorageLocation getShoppingStorageLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { storageLocationId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
