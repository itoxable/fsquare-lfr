 ...
 * @generated
 */
public class ShoppingShippingMethodLocalServiceClp
    ...
    public com.fsquare.shopping.model.ShoppingShippingMethod createShoppingShippingMethod(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { shippingMethodId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingShippingMethod deleteShoppingShippingMethod(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { shippingMethodId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingShippingMethod fetchShoppingShippingMethod(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { shippingMethodId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.fsquare.shopping.model.ShoppingShippingMethod getShoppingShippingMethod(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { shippingMethodId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
