...
public class ShoppingItemTypePersistenceImpl extends BasePersistenceImpl<ShoppingItemType>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_COMPANYID =
        new FinderPath(ShoppingItemTypeModelImpl.ENTITY_CACHE_ENABLED,
            ...
            ShoppingItemTypeModelImpl.COMPANYID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYID = new FinderPath(ShoppingItemTypeModelImpl.ENTITY_CACHE_ENABLED,
            ShoppingItemTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCompanyId",
            new String[] { Long.class.getName() });
    private static final String _FINDER_COLUMN_COMPANYID_COMPANYID_2 = "shoppingItemType.companyId = ?";
    public static final FinderPath FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID = new FinderPath(ShoppingItemTypeModelImpl.ENTITY_CACHE_ENABLED,
            ShoppingItemTypeModelImpl.FINDER_CACHE_ENABLED,
            ShoppingItemTypeImpl.class, FINDER_CLASS_NAME_ENTITY,
            "fetchByNameAndCompanyId",
            new String[] { String.class.getName(), Long.class.getName() },
            ShoppingItemTypeModelImpl.NAME_COLUMN_BITMASK |
            ShoppingItemTypeModelImpl.COMPANYID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_NAMEANDCOMPANYID = new FinderPath(ShoppingItemTypeModelImpl.ENTITY_CACHE_ENABLED,
            ShoppingItemTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
            "countByNameAndCompanyId",
            new String[] { String.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_NAMEANDCOMPANYID_NAME_1 = "shoppingItemType.name IS NULL AND ";
    private static final String _FINDER_COLUMN_NAMEANDCOMPANYID_NAME_2 = "shoppingItemType.name = ? AND ";
    private static final String _FINDER_COLUMN_NAMEANDCOMPANYID_NAME_3 = "(shoppingItemType.name IS NULL OR shoppingItemType.name = '') AND ";
    private static final String _FINDER_COLUMN_NAMEANDCOMPANYID_COMPANYID_2 = "shoppingItemType.companyId = ?";
     ...
     */
    @Override
    public List<ShoppingItemType> findByCompanyId(long companyId)
     ...
     */
    @Override
    public List<ShoppingItemType> findByCompanyId(long companyId, int start,
    ...
    public List<ShoppingItemType> findByCompanyId(long companyId, int start,
        ...
        if ((list != null) && !list.isEmpty()) {
            for (ShoppingItemType shoppingItemType : list) {
                if ((companyId != shoppingItemType.getCompanyId())) {
                    list = null;
     ...
     */
    @Override
    public ShoppingItemType findByCompanyId_First(long companyId,
        OrderByComparator orderByComparator)
        throws NoSuchShoppingItemTypeException, SystemException {
        ShoppingItemType shoppingItemType = fetchByCompanyId_First(companyId,
                orderByComparator);
     ...
     */
    @Override
    public ShoppingItemType fetchByCompanyId_First(long companyId,
        OrderByComparator orderByComparator) throws SystemException {
        List<ShoppingItemType> list = findByCompanyId(companyId, 0, 1,
                orderByComparator);
     ...
     */
    @Override
    public ShoppingItemType findByCompanyId_Last(long companyId,
        OrderByComparator orderByComparator)
        throws NoSuchShoppingItemTypeException, SystemException {
        ShoppingItemType shoppingItemType = fetchByCompanyId_Last(companyId,
                orderByComparator);
     ...
     */
    @Override
    public ShoppingItemType fetchByCompanyId_Last(long companyId,
        OrderByComparator orderByComparator) throws SystemException {
        ...
        List<ShoppingItemType> list = findByCompanyId(companyId, count - 1,
     ...
     */
    @Override
    public ShoppingItemType[] findByCompanyId_PrevAndNext(long itemTypeId,
        ...
        try {
            ...
            array[0] = getByCompanyId_PrevAndNext(session, shoppingItemType,
                    companyId, orderByComparator, true);

            array[1] = shoppingItemType;

            array[2] = getByCompanyId_PrevAndNext(session, shoppingItemType,
    ...
    protected ShoppingItemType getByCompanyId_PrevAndNext(Session session,
        ShoppingItemType shoppingItemType, long companyId,
    ...
    public void removeByCompanyId(long companyId) throws SystemException {
        for (ShoppingItemType shoppingItemType : findByCompanyId(companyId,
     ...
     */
    @Override
    public ShoppingItemType findByNameAndCompanyId(String name, long companyId)
        throws NoSuchShoppingItemTypeException, SystemException {
        ShoppingItemType shoppingItemType = fetchByNameAndCompanyId(name,
                companyId);
     ...
     */
    @Override
    public ShoppingItemType fetchByNameAndCompanyId(String name, long companyId)
        throws SystemException {
        return fetchByNameAndCompanyId(name, companyId, true);
    }
     ...
     */
    @Override
    public ShoppingItemType fetchByNameAndCompanyId(String name,
        ...
        if (retrieveFromCache) {
            result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
                    finderArgs, this);
        }
        ...
        if (result instanceof ShoppingItemType) {
            ...
            if (!Validator.equals(name, shoppingItemType.getName()) ||
                    (companyId != shoppingItemType.getCompanyId())) {
                result = null;
            }
        }
        ...
        if (result == null) {
            ...
            if (name == null) {
                query.append(_FINDER_COLUMN_NAMEANDCOMPANYID_NAME_1);
            } else if (name.equals(StringPool.BLANK)) {
                query.append(_FINDER_COLUMN_NAMEANDCOMPANYID_NAME_3);
            } else {
                bindName = true;

                query.append(_FINDER_COLUMN_NAMEANDCOMPANYID_NAME_2);
            }

            query.append(_FINDER_COLUMN_NAMEANDCOMPANYID_COMPANYID_2);
            ...
            try {
                ...
                if (list.isEmpty()) {
                    FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
                        finderArgs, list);
                } else {
                    ...
                    if ((shoppingItemType.getName() == null) ||
                            ...
                            (shoppingItemType.getCompanyId() != companyId)) {
                        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
                            finderArgs, shoppingItemType);
                    }
                }
            } catch (Exception e) {
                FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
                    finderArgs);
     ...
     */
    @Override
    public ShoppingItemType removeByNameAndCompanyId(String name, long companyId)
        throws NoSuchShoppingItemTypeException, SystemException {
        ShoppingItemType shoppingItemType = findByNameAndCompanyId(name,
                companyId);
     ...
     */
    @Override
    public int countByNameAndCompanyId(String name, long companyId)
        throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_NAMEANDCOMPANYID;
    ...
    public void cacheResult(ShoppingItemType shoppingItemType) {
        ...
        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
            new Object[] {
                shoppingItemType.getName(), shoppingItemType.getCompanyId()
            }, shoppingItemType);
    ...
    protected void cacheUniqueFindersCache(ShoppingItemType shoppingItemType) {
        if (shoppingItemType.isNew()) {
            ...
            FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_NAMEANDCOMPANYID,
                args, Long.valueOf(1));
            FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
            ...
            if ((shoppingItemTypeModelImpl.getColumnBitmask() &
                    FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        shoppingItemType.getName(),
                        shoppingItemType.getCompanyId()
                    };
    ...
    protected void clearUniqueFindersCache(ShoppingItemType shoppingItemType) {
        ...
        FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_NAMEANDCOMPANYID, args);
        FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID, args);

        if ((shoppingItemTypeModelImpl.getColumnBitmask() &
                FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID.getColumnBitmask()) != 0) {
            args = new Object[] {
                    shoppingItemTypeModelImpl.getOriginalName(),
                    shoppingItemTypeModelImpl.getOriginalCompanyId()
                };

            FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_NAMEANDCOMPANYID,
                args);
            FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_NAMEANDCOMPANYID,
                args);
        }
    ...
    public ShoppingItemType updateImpl(
        ...
        if (isNew || !ShoppingItemTypeModelImpl.COLUMN_BITMASK_ENABLED) {
            ...
            if ((shoppingItemTypeModelImpl.getColumnBitmask() &
                ...
                args = new Object[] { shoppingItemTypeModelImpl.getCompanyId() };
