...
import com.fsquare.shopping.model.ShoppingOrderModel;
import com.fsquare.shopping.model.ShoppingOrderSoap;
...
/**
 * The base model implementation for the ShoppingOrder service. Represents a row in the &quot;FsquareShopping_ShoppingOrder&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.fsquare.shopping.model.ShoppingOrderModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ShoppingOrderImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ShoppingOrderImpl
 * @see com.fsquare.shopping.model.ShoppingOrder
 * @see com.fsquare.shopping.model.ShoppingOrderModel
 * @generated
 */
@JSON(strict = true)
public class ShoppingOrderModelImpl extends BaseModelImpl<ShoppingOrder>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a shopping order model instance should use the {@link com.fsquare.shopping.model.ShoppingOrder} interface instead.
     */
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.com.fsquare.shopping.model.ShoppingOrder"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.com.fsquare.shopping.model.ShoppingOrder"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.com.fsquare.shopping.model.ShoppingOrder"),
            true);
    public static long COMPANYID_COLUMN_BITMASK = 1L;
    public static long EXTERNALPAYMENTID_COLUMN_BITMASK = 2L;
    ...
    public Object clone() {
        ...
        shoppingOrderImpl.setStatus(getStatus());
    ...
    public CacheModel<ShoppingOrder> toCacheModel() {
        ...
        shoppingOrderCacheModel.status = getStatus();

        String status = shoppingOrderCacheModel.status;

        if ((status != null) && (status.length() == 0)) {
            shoppingOrderCacheModel.status = null;
        }
